...
var (
	...
	gitVersion   string = "v0.0.0-master+31bf3ed48b91b67e5003d8df1b3bd0b918d1fb94"
	gitCommit    string = "31bf3ed48b91b67e5003d8df1b3bd0b918d1fb94" // sha1 from git, output of $(git rev-parse HEAD)
